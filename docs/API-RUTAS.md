...
| **POST** | `/api/v1/auth/login` | Login con email y contraseña. Si solo se envía `email` (o `password` vacío), envía OTP al correo. Respuestas: 200, 401, 404, 503. | Body: `email`, `password?` (omitir o `""` para pedir OTP) |
